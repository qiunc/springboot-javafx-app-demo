...
import com.pdai.javafx.app.utils.MyUtils;
...
public class DialogBuilder {
    ...
    public DialogBuilder setTextFieldText(String hint,OnInputListener onInputListener) {
    ...
    public JFXAlert<String> create() {
        ...
        //不为空，则回调接口
        if(input.isPresent()) {
            input.ifPresent(setValue -> {
                onInputListener.onGetText(setValue);
            });
        }
        return alert;
    }
